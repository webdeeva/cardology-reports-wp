...
<body style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;line-height:1.6;color:#333;max-width:600px;margin:0 auto;padding:20px;">
	<div style="background:linear-gradient(135deg,#380611,#000);color:#f5c542;padding:24px;border-radius:10px 10px 0 0;text-align:center;">
		<h1 style="margin:0;"><?php echo esc_html__( 'Your report is being prepared', 'cardology-reports' ); ?></h1>
	</div>
	<div style="background:#f8f9fa;padding:24px;border-radius:0 0 10px 10px;">
		...
		<p><?php echo esc_html__( "Thanks for your order — your personalized reading is being written now. Reports typically take 10–15 minutes.", 'cardology-reports' ); ?></p>
		<p style="text-align:center;margin:24px 0;">
			<a href="<?php echo esc_url( $status_url ); ?>" style="background:#f5c542;color:#000;padding:12px 24px;border-radius:6px;text-decoration:none;font-weight:600;">
